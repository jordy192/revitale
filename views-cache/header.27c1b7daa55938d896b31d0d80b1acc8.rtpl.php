...
<!--
    Revitale Store by jordylucas_1@hotmail.com
-->
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <?php } ?>
                            <li><a href="/admin"><i class="fa fa-folder-open"></i> Admin</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="btn dropdown" href="#"><div class="btn dropdown" data-toggle="dropdown">Produtos<span class="caret"></span></div>
                                <ul class="dropdown-menu">
                                    <?php require $this->checkTemplate("categories-menu");?>
                              </ul>
                        </li>
                        <!--<li><a class="btn" href="/cart">Carrinho</a></li>-->
                    </ul>
                </div>  
            </div>
        </div>
