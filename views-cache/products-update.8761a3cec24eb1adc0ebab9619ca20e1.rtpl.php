  	...
  	<div class="col-md-12">
        ...
        <form role="form" action="/admin/products/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="descriptup">Descrição Principal</label>
              <textarea type="text" class="form-control" id="descriptup" rows="8"  name="descriptup" placeholder="Digite a descrição principal" value="<?php echo htmlspecialchars( $product["descriptup"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $product["descriptup"], ENT_COMPAT, 'UTF-8', FALSE ); ?></textarea>
            </div>

            <div class="form-group">
              <label for="descriptdown">Descrição Secundária</label>
              <textarea type="text" class="form-control"  id="descriptdown" rows="4" name="descriptdown" placeholder="Digite a descrição secundária" value="<?php echo htmlspecialchars( $product["descriptdown"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $product["descriptdown"], ENT_COMPAT, 'UTF-8', FALSE ); ?></textarea>
            </div>
