        ...
        <form role="form" action="/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <textarea type="textarea" class="form-control" rows="8" id="descriptup" name="descriptup" placeholder="Digite a descrição principal"></textarea>
            </div>
            <div class="form-group">
              <label for="descriptdown">Descrição Secundária</label>
              <textarea type="textarea" class="form-control" rows="4" id="descriptdown" name="descriptdown" placeholder="Digite a descrição secundária"></textarea>
            </div>
          </div>
          <!-- /.box-body -->
